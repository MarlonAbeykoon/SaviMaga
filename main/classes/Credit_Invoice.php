...
class Credit_Invoice {
    ...
    function addCrediInvoice($totalAmount, $grantAmount, $InterestRate, $DailyEqualPayment, $Days, $PaidAmount, $Settled, $Debitors_idDebitors, $CollectionArea_idCollectionArea, $userid) {
//        $d = mktime(11, 14, 54, 8, 12, 2014);
        $Date = date("Y-m-d");
        $sql = "INSERT INTO credit_invoice (TotalAmount,GrantAmount,InterestRate,DailyEqualPayment,Days,PaidAmount,Settled,DateTime,Debitors_idDebitors,CollectionArea_idCollectionArea,Status,user_idUser) "
                . "VALUES ($totalAmount,$grantAmount, '$InterestRate', '$DailyEqualPayment', '$Days','$PaidAmount','$Settled','$Date','$Debitors_idDebitors','$CollectionArea_idCollectionArea', '0',$userid)";
