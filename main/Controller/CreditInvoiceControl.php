...
try {
    ...
    if ($applicantid == "") {
        ...
        if ($id > 0) {
            ...
            $res = $credit->addCrediInvoice(bcadd(0, $totalAmount, 2), $grantAmount, $InterestRate, bcadd(0, $dailypay, 2), $days, 0, 0, $id, $area, $user_de);
        ...
        $credit = new Credit_Invoice();
        $res = $credit->addCrediInvoice(bcadd(0, $totalAmount, 2), $grantAmount, $InterestRate, bcadd(0, $dailypay, 2), $days, 0, 0, $applicantid, $area, $user_de);
