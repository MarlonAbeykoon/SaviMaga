                                ...
                                <div class="card-body">
                                    ...
                                    <form id="form">
                                        <div class="form-body" id="paymentFormBody">
                                            <h3 class="card-title">Expenses Info</h3>
                                            <hr>
                                            <div class="row p-t-20">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label">Details</label>
                                                        <input type="text" id="details" class="form-control" placeholder="" required>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-success" onclick="addExpenses();"> <i class="fa fa-check"></i> Save</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
CollectorExpenses
WHERE
CollectorExpenses.user_idUser = $user_de
ORDER BY
