    ...
    return function (a, b, c) {
        ...
        c.namespaces = {svg: "http://www.w3.org/2000/svg", xmlns: "http://www.w3.org/2000/xmlns/", xhtml: "http://www.w3.org/1999/xhtml", xlink: "http://www.w3.org/1999/xlink", ct: "http://gionkunz.github.com/chartist-js/ct"}, c.noop = function (a) {
            ...
            if (e && c.projectLength(a, 1, j) >= d)
                ...
                for (; ; ) {
                    if (l && c.projectLength(a, j.step, j) <= d)
                        ...
                        if (l || !(c.projectLength(a, j.step / 2, j) >= d))
                            break;
            ...
            if (n[f.units.pos] = a + h[f.units.pos], n[f.counterUnits.pos] = h[f.counterUnits.pos], n[f.units.len] = b, n[f.counterUnits.len] = g - 10, k) {
                ...
                m = i.elem("text", n, j.join(" ")).text(e[d]);
        ...
        c.Interpolation = {}, c.Interpolation.none = function (a) {
            ...
            function b(b, c) {
                for (var d = [], e = !0, f = 0; f < b.length; f += 2)
                    void 0 === c[f / 2].value ? a.fillHoles || (e = !0) : (e && (d.push({pathCoordinates: [], valueData: []}), e = !1), d[d.length - 1].pathCoordinates.push(b[f], b[f + 1]), d[d.length - 1].valueData.push(c[f / 2]));
                return d
            }
            ...
            return function g(a, d) {
                ...
                if (h.length) {
                    ...
                    if (a = h[0].pathCoordinates, d = h[0].valueData, a.length <= 4)
        ...
        c.Svg = c.Class.extend({constructor: d, attr: e, elem: f, parent: g, root: h, querySelector: i, querySelectorAll: j, foreignObject: k, text: l, empty: m, remove: n, replace: o, append: p, classes: q, addClass: r, removeClass: s, removeAllClasses: t, height: u, width: v, animate: w}), c.Svg.isSupported = function (a) {
        ...
        function d(a) {
            ...
            if (a.stackBars && 0 !== d.normalized.length) {
                ...
                b = c.getHighLow(d.normalized, c.extend({}, a, {referenceValue: 0}), a.horizontalBars ? "x" : "y");
